...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class WP_Customize_Control_Tinymce_Editor extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'control-editor', get_theme_file_uri( 'js/control-editor.js' ), [ 'jquery', 'customize-preview' ], filemtime( get_theme_file_path( 'js/control-editor.js' ) ), true );
			wp_add_inline_script( 'control-editor', "jQuery( document ).ready( function () { jQuery( '#customize-control-{$this->id}' ).WPCustomizeTinymceEditor(); } );", 'after' );
		}
